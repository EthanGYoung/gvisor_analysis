...
void *spinup(void *id) {
        ...
        //printf( "Thread %d done in %d seconds and %ld nanoseconds. Throughput: %f\n", thread_id, t.tv_sec, t.tv_nsec, results[thread_id]);
	return NULL;
}
