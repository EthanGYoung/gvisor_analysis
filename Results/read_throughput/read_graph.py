...
if (sys.argv[2] == "bar"):
	...
	ax.text(0.43,0.85,'46K') #tmpfs 4k	
	ax.text(1.43,2.35,'37K') #tmpfs 16K	
	ax.text(2.43,5.35,'19K') #tmpfs 64K	
	ax.text(3.43,6.5,'0.281K') #tmpfs 256K	
	ax.text(4.43,6.75,'0.095K') #tmpfs 1M	
